...
default), *Calm* (10), *Calmer* (7), *Plain* (one flat color per track/stream), or *Tableau*
(10 hand-balanced curated colors) — to dial down color noise on busy traces. The palette is
independent of the theme and is remembered across sessions.
